...
application = service.Application(SLAVES[2][2])

# this is the line that needs to be added to this configuration, in order
# for the logger to work
application.setComponent(ILogObserver, logger('{}.log'.format(SLAVES[2][2])))

echoService = internet.TCPServer(SLAVES[2][1], SlaveFactory())
